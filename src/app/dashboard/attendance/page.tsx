...
// Sample attendance data for demonstration (moved outside component)
const getSampleAttendance = (selectedDate: string): AttendanceRecord[] => [
    {
      id: '1',
      employee_id: '001',
      date: selectedDate,
...
export default function AttendancePage() {
  ...
  const loadAttendance = useCallback(async () => {
    setLoading(true)
    const sampleData = getSampleAttendance(selectedDate)
    try {
      ...
      if (error) {
        ...
        setAttendanceRecords(data || sampleData)
      }

      calculateStats(data || sampleData)
    } catch (err) {
      setAttendanceRecords(sampleData)
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                variant="outline"
                onClick={() => {
                  exportAttendanceToExcel(attendanceRecords as unknown as Record<string, unknown>[])
