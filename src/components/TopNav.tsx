  ...
  '/dashboard/employees': [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Work Locations', href: '/dashboard/locations' },
    ...
    },
    {
      label: 'Records',
      items: [
        { label: 'Performance Goals', href: '/dashboard/performance/goals' },
        { label: 'Training Courses', href: '/dashboard/training/courses' },
