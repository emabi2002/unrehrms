-- =====================================================
-- MIGRATION 006: Comprehensive HRMS Tables (FIXED - Idempotent)
...
-- Basic RLS policies (adjust based on your authentication)
-- Drop existing policies if they exist, then recreate
DROP POLICY IF EXISTS select_all ON positions;
CREATE POLICY select_all ON positions FOR SELECT USING (true);

DROP POLICY IF EXISTS select_all ON work_locations;
CREATE POLICY select_all ON work_locations FOR SELECT USING (true);

DROP POLICY IF EXISTS select_all ON leave_types;
CREATE POLICY select_all ON leave_types FOR SELECT USING (true);

-- =====================================================
-- MIGRATION COMPLETE
-- =====================================================

SELECT 'Migration 006 (FIXED): Comprehensive HRMS Tables completed successfully' AS status;
