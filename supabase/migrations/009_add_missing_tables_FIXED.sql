-- =====================================================
-- PNG UNRE HRMS - Add Missing Tables (FIXED)
-- Migration 009: Payslips, Tax Brackets, Certifications
-- FIXED: Uses correct primary key column names
-- =====================================================

-- =====================================================
-- 1. PAYSLIPS TABLE (FIXED)
-- =====================================================
...
SELECT
  '✅ All 4 tables created successfully!' AS status,
  '2025 PNG tax brackets seeded (6 brackets)' AS tax_data,
  'Database is now 100% complete!' AS message,
  '23/23 tables active' AS completion;
